...
LASTFM_TOPTRACKS_API_URL = 'http://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&api_key={}&format=json'
...
def top_tracks(country):
    try:
        if country:
            ...
            data = requests.get(LASTFM_TOPTRACKS_API_URL.format(LASTFM_API_KEY)).json()
